...
def generate_network(Nm, Km, pR, Nx1, Nx2):
    ...
    Dsep = float(0.25)  # Dsep in [0, 1]. Determines the distance between first point of contacts in the moderate network of each of the extremist community
...
def main():
    ...
    Km = int(32) # Average degree of the moderate network
    ...
    if topology == "ring-lattice":
        ...
        pR = float(1)
    export_filename = topology+"_network_"+str(pe)+"_K16_D0_25.csv"
