...
def generate_network(Nm, Km, pR, Nx1, Nx2):
    ...
    Dsep = float(0.75)  # Dsep in [0, 1]. Determines the distance between first point of contacts in the moderate network of each of the extremist community
...
def main():
    ...
    if topology == "ring-lattice":
        ...
        pR = float(1)
    export_filename = topology+"_network_"+str(pe)+"_K16_D0_75.csv"
